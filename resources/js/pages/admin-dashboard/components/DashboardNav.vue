        ...
        <ul class="navbar-nav align-items-center ml-auto ml-md-0">
          <li class="nav-item dropdown">
            <div
              ...
              aria-expanded="false"
            >
              <b class="nav-link-inner--text" id="navbar-language">{{
                $store.state.language === "en" ? "Language" : "ဘာသာစကား"
              }}</b>
            </div>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <router-link to="/admin/twod-threed" class="dropdown-item">
              ...
              <router-link to="/admin/betslip-history" class="dropdown-item">
              ...
              <router-link to="/admin/deposit" class="dropdown-item">
                <i class="ni ni-credit-card"></i>
                {{ $store.state.language === "en" ? "Deposit" : "ငွေသွင်း" }}
              </router-link>
              <router-link to="/admin/withdraw" class="dropdown-item">
              ...
              <router-link to="/admin/twod-management" class="dropdown-item">
              ...
              <router-link to="/admin/threed-management" class="dropdown-item">
              ...
              <router-link to="/admin/payment-accounts" class="dropdown-item">
              ...
              <router-link to="/admin/ledger" class="dropdown-item">
