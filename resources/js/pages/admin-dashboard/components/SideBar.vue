        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            >
              <router-link
                to="/admin/products"
                :class="linkIsActive('/admin/products') ? 'active' : ''"
                class="nav-link"
              >
            ...
            >
              <router-link
                ...
                :class="linkIsActive('/admin/dynamic-names') ? 'active' : ''"
                class="nav-link"
              >
            ...
            >
              <router-link
                to="/admin/contacts"
                :class="linkIsActive('/admin/contacts') ? 'active' : ''"
                class="nav-link"
              >
                <i class="ni ni-tv-2"></i>
                <b class="nav-link-text">Contacts</b>
              </router-link>
            </li>
          </ul>
          <!-- Divider -->
...
export default {
  ...
  mounted() {
    ...
    this.withdrawsInterval = setInterval(() => this.checkWithdraws(), 600000);
