    ...
    <div>
        ...
        <section class="checkout spad">
            <div class="container">
                ...
                <p>
                  After you have ordered, our admin will contact email or phone
                  number you provided! Thank for your ordering.
                </p>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="checkout__order">
                  ...
                  <ul>
                    <li
                      v-for="(order, index) in $store.state.cart"
                      :key="index"
                    >
                      {{ order.name }}
                      <span>{{ order.quantity }} x {{ order.price }} MMK </span>
                    </li>
                  </ul>
                  <div class="checkout__order__subtotal">
                    Subtotal
                  ...
                  <button type="button" @click="finalOrder" class="site-btn">
                    PLACE ORDER
                  </button>
                </div>
              </div>
